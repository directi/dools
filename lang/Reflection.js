...
dojo.declare(
	...
	null,
	{
		...
		constructor:function(/*String*/moduleName, /*String?*/methodName, /*Object?*/scope){
			// summary: Init the class with either a module or a module and a method to inspect.
			// moduleName: String
			...
			// 		>>> new dools.lang.Reflection("dools.lang.Reflection", "getType").getMethod()
		...
		getType:function(){ // Is getType a good name???? not better getKind()
			// >>> new dools.lang.Reflection("dools.lang.Reflection").getType()
			// "class"
			// >>> new dools.lang.Reflection("dojo.query").getType()
			// "function"
			// >>> dojo.require("dojo.cookie");
			// >>> new dools.lang.Reflection("dojo.cookie").getType()
			// "function"
			// >>> new dools.lang.Reflection("dojo.string").getType()
			// "module"
			// >>> new dools.lang.Reflection("dojox").getType()
			// "module"
			// >>> new dools.lang.Reflection("dojo").getType()
			// "module"
		...
		getApi:function( /* bool */ includeInherited){
			...
			//
			// >>> var api = new dools.lang.Reflection("dools.lang.Reflection").getApi()
		...
		getMethods:function( /* bool */ includeInherited){
			...
			for (var i in p){
				var isInherited = !!(s && s[i] && s[i].toString() == p[i].toString()),
					...
					returnInherited = (all || !isInherited);
		...
		getProperties:function( /* bool */ includeInherited){
			...
			var all = includeInherited==true,
				ret = {},
				m = this.module, p = m.prototype, s = m.superclass;
			for (var i in p){
				var isInherited = !!(s && s[i] && s[i].toString() == p[i].toString()),
					isOverridden = !!(s && s[i] && s[i].toString() != p[i].toString());
